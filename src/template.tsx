...
// =============================================================
// COMPONENT DEFAULT PROPS (Schema + Content)
// This object defines the starting state for the Studio environment.
// Developers should update this to reflect their widget's default copy.
// =============================================================
export const DEFAULT_WIDGET_PROPS: Partial<WidgetView> = {
  // ---- Identity ----
  widget_id: 'template_v1',
  link_id: 'mock_link',
  slug: 'try-your-luck',
...
// =============================================================
const WidgetTemplate: FC<WidgetView> = (props) => {
  // Merge incoming props with defaults for robustness
  const {
    widget_id,
    link_id,
    theme_primary,
    theme_secondary,
    theme_accent = DEFAULT_WIDGET_PROPS.theme_accent,
    theme_line_height = DEFAULT_WIDGET_PROPS.theme_line_height,
    text1,
    text2,
    text3,
    text4,
  ...
  } = { ...DEFAULT_WIDGET_PROPS, ...props } as WidgetView;
