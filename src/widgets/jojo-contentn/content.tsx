export const Content = () => {
  return (
    <div id="jojo-contentn-container" className="p-8 border border-white/10 rounded-3xl shadow-2xl bg-black/40 backdrop-blur-xl text-white">
